...
if testCount == nil then
  if not enigma then
    ...
    enigma:FindAbilityByName("splittertd_dummy_unit"):SetLevel(1)
    ...
    planet1:FindAbilityByName("splittertd_dummy_unit"):SetLevel(1)
    ...
    planet2:FindAbilityByName("splittertd_dummy_unit"):SetLevel(1)
    ...
    planet3:FindAbilityByName("splittertd_dummy_unit"):SetLevel(1)
...
if testCount == 0 then
  ...
  --[[for i=1,4 do
    ...
    --units[i]:FindAbilityByName("splittertd_dummy_unit"):SetLevel(1)
...
if testCount == 3 then
  ...
  Timers:CreateTimer("timer", {
    callback = function()
      ...
      unit:FindAbilityByName("splittertd_dummy_unit"):SetLevel(1)
